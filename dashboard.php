...
<body>
    <div class="container">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <div class="container-fluid">
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="/daffa/dashboard.php">Home</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="col-12">
                ...
                if(isset($_GET['page'])){
                    if ($_GET['page']=="anggota") {
                        ...
                        echo "<center><h1>Halaman yang anda cari tidak ditemukan!</h1></center>";
                    }
                }else{
        ...
        <div class="row">
            <div class="col">
                <center>&copy;Muhammad Daffa Abiyyu Syaddad 2021</center>
            </div>
        </div>
    </div>
